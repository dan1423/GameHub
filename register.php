...
if (isset($_POST['submitted'])) {
    ...
    if (empty($errors)) { // If everything's OK.
        ...
        // Make the query:
        $q = "INSERT INTO user (user_type_id, first_name, last_name, email, user_pw, registration_date) VALUES ($t, '$fn', '$ln', '$e', SHA1('$p'), NOW() )";		
...
// Make the query:
$q = "SELECT user_type_id, type_name FROM user_type ORDER BY type_name ASC";		
